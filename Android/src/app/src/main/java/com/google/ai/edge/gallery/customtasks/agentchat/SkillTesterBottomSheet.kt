  ...
  ModalBottomSheet(onDismissRequest = onDismiss, sheetState = sheetState) {
    Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
      ...
      OutlinedTextField(
        ...
        label = { Text(stringResource(R.string.skill_tester_input_data_label)) },
      ...
      OutlinedTextField(
        ...
        label = { Text(stringResource(R.string.skill_tester_custom_data_label)) },
        modifier = Modifier.fillMaxWidth().padding(bottom = 16.dp),
      )

      // Tab Panel
      val tabs = listOf(stringResource(R.string.skill_tester_tab_result), stringResource(R.string.skill_tester_tab_logs))
